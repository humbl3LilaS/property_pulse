                ...
                >
                  ...
                  {!session && <div>
                      {providers && Object.values(providers).map((provider, idx) =>
                          <button
                              className=" px-3 py-2  flex items-center gap-x-2 rounded-md bg-black/50 text-black text-base font-medium transition-colors duration-500 hover:bg-gray-700 hover:text-white"
                              key={idx}
