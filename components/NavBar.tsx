...
function NavBar() {
    ...
    return (
        <nav>
            <div className={"w-full p-4 bg-blue-700 flex justify-between items-center md:gap-x-10 md:justify-center lg:gap-x-40"}>
                <MobileMenu/>
                ...
                <ul className={"hidden items-center gap-x-6 text-white md:flex"}>
                    ...
                    {isLogin && <NavLink href="/properties/add">Add</NavLink>}

                </ul>
                <div className={"hidden md:flex items-center gap-x-2 md:gap-x-4"}>
                    {!isLogin && <NavLink href="/login" className={" hidden  items-center gap-x-2 text-white md:flex"}>
                        <FaGoogle/>
